...
BEGIN
    ...
    SELECT @set = @set + 
	   '<TARGETFIELD BUSINESSNAME ="" DATATYPE ="' + CASE WHEN m.TypeName = 'timestamp' THEN 'binary' ELSE m.TypeName END +'" DESCRIPTION ="" FIELDNUMBER ="' + CAST(m.ColumnId AS VARCHAR) + '" '
