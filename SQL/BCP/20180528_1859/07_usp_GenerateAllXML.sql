...
BEGIN
    ...
    */
    ...
    SET @XML = ''
    SET @XML = N'<?xml version="1.0" encoding="' + @IPC_XML_Encoding + '"?>'
    SET @XML = @XML + nchar(10) + N'<!DOCTYPE POWERMART SYSTEM "powrmart.dtd">'
    SET @XML = @XML + nchar(10) + N'<POWERMART CREATION_DATE="" REPOSITORY_VERSION="">'
