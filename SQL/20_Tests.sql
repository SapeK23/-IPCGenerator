...
DECLARE @ETLGenerateVersion varchar(50) = 'MS_GenV4'
DECLARE @XML nvarchar(max);

/* Generate IPC object */
-- exec ipc.usp_GenerateAllXML @p_SchemaName = 'Sales', @p_TableName = 'SalesPersonQuotaHistory', @p_ETLGenerateVersion = @ETLGenerateVersion 
...
SELECT @XML, len(@XML), cast(@XML AS xml) 
